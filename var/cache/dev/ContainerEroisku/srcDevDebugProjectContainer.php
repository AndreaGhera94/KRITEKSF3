...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->services = [];
        $this->normalizedIds = [
            'app\\repository\\invoicelinesrepository' => 'App\\Repository\\InvoiceLinesRepository',
        ...
        $this->fileMap = [
            'App\\Repository\\InvoiceLinesRepository' => 'getInvoiceLinesRepositoryService.php',
