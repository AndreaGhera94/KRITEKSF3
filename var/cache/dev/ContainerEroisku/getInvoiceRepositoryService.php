...
return $this->services['App\\Repository\\InvoiceRepository'] = new \App\Repository\InvoiceRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->load('getDoctrineService.php')) && false ?: '_'});
