...
// Returns the private 'App\Repository\InvoiceLinesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/InvoiceLinesRepository.php';

return $this->services['App\\Repository\\InvoiceLinesRepository'] = new \App\Repository\InvoiceLinesRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->load('getDoctrineService.php')) && false ?: '_'});
